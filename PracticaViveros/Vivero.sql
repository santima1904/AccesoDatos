...
--DBCC CHECKIDENT (TipoPlanta, RESEED, 0)
--DBCC CHECKIDENT (UsuarioGestor, RESEED, 0)
--DBCC CHECKIDENT (UsuarioVendedor, RESEED, 0)

--Select pa probar
--SELECT * FROM Cliente
--SELECT * FROM Producto
--SELECT * FROM ProductoJardineria
--SELECT * FROM ProductoPlanta
