...
public class Salida {
    ...
    public static final String MENSAJE_PEDIR_NOMBRE_BBDD="Introduzca el nombre de la Base de Datos a la que desea conectarse";
    ...
    public static final String DATOS_NO_ELIMINADOS = "No se ha actualizado la base de datos, probablemente estes intentando borrar un dato ya borrado";
    public static final String DATOS_NO_MODIFICADOS = "No se ha actualizado la base de datos, probablemente estes intentando modificar un dato que no existe";
    public static final String OPERACIONES_EXITOSAS = "Operacion realizada con exito.";

    public static void mostrarColumnasCliente(){
        System.out.println("""
            
            -------------------------------------
            Elige del cliente el atributo que desee cambiar
    ...
    public static void mostrarColumnasProducto(){
        System.out.println("""
            ...
            -------------------------------------
            Elige del producto el atributo que desee cambiar
    ...
    public static void mostrarColumnasVendedor(){
        System.out.println("""
            ...
            -------------------------------------
            Elige del vendedor el atributo que desee cambiar
    ...
    public static void mostrarMensajeBienvenida(){
        System.out.println("""
                ----------------------------------------
                Bienvenido a MartinezAral Viveros.
                Esperemos que disfrute del dia :)
                ----------------------------------------""");
    }
    /**
    ...
    public static void errorBorrarFactura() {
        System.out.println("Ha ocurrido un error, la factura que estas intentado borrar tiene dependencias, por ende no se puede borrar");
    }


    public static void mostrarCategoriasPlanta() {
        System.out.println("""
                ----------------------------------------
                Elige la categoria de la planta
                
                1.- Plantas de Interior.
                2.- Plantas de Exterior.
                3.- Arboles Ornamentales.
                4.- Arboles Frutales.
    ...
    public static void mostrarTiposProducto() {
        System.out.println("""
                ----------------------------------------
                Elige el tipo de producto
                
                1.- Producto Jardineria.
                2.- Producto Planta.
